...
If the installation was successful you will get a message about the successful installation of the playground and a hint, that a command ? has been provided for quick help regarding the playground.
